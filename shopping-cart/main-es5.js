(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var CardDetailsComponent = /** @class */ (function () {
                function CardDetailsComponent(productService) {
                ...
                CardDetailsComponent.prototype.getProducts = function () {
                    var _this = this;
                    this.productService.productListUpdates$.subscribe(function (products) {
                        _this.products = products;
                    });
                };
                return CardDetailsComponent;
            }());
            CardDetailsComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var CartProductComponent = /** @class */ (function () {
                function CartProductComponent(productService) {
                    this.productService = productService;
                ...
                CartProductComponent.prototype.priceAfterDiscount = function (actualPrice, discount) {
                    return actualPrice - (actualPrice * discount / 100);
                };
                CartProductComponent.prototype.increaseCount = function (product) {
                    product.count++;
                    this.productService.updateProductCount(product);
                };
                CartProductComponent.prototype.decreaseCount = function (product) {
                    product.count--;
                    if (product.count === 0) {
                ...
                CartProductComponent.prototype.remove = function (product) {
                    this.productService.removeSelectedProducts(product);
                };
                return CartProductComponent;
            }());
            CartProductComponent.ctorParameters = function () { return [
                { type: _services_product_service__WEBPACK_IMPORTED_MODULE_2__["ProductService"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var PriceDetailComponent = /** @class */ (function () {
                function PriceDetailComponent(productService) {
                    this.productService = productService;
                ...
                PriceDetailComponent.prototype.calculateTotalDiscount = function () {
                    this.totalDiscount = 0;
                    for (var i = 0; i < this.products.length; i++) {
                        var discountedPrice = this.products[i].count * (this.products[i].price - (this.products[i].price * this.products[i].discount / 100));
                        this.totalDiscount += (this.products[i].count * this.products[i].price) - discountedPrice;
                    }
                };
                PriceDetailComponent.prototype.calculateTotalPayable = function () {
                    this.totalPayable = 0;
                    for (var i = 0; i < this.products.length; i++) {
            ...
            PriceDetailComponent.ctorParameters = function () { return [
                { type: _services_product_service__WEBPACK_IMPORTED_MODULE_2__["ProductService"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var FilterComponent = /** @class */ (function () {
                ...
                FilterComponent.prototype.getFilterDetails = function () {
                    return this.filterDetails;
                };
                FilterComponent.prototype.setFilterDetails = function () {
                    this.filterDetails = {
                        type: "priceRange",
                        priceRange: [this.value, this.highValue]
                    };
                };
                FilterComponent.prototype.saveFilterDetail = function () {
                    this.setFilterDetails();
                    this.filerOption.emit(this.filterDetails);
                    this.closePopup.emit();
                };
                FilterComponent.prototype.cancelFilter = function () {
                    this.closePopup.emit();
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ShoppingCartComponent = /** @class */ (function () {
                ...
                ShoppingCartComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.productService.productListUpdates$.subscribe(function (selectedProductList) {
                        if (selectedProductList.length > 0) {
                            _this.isBatchVisible = true;
                        }
                        else {
                            _this.isBatchVisible = false;
                        }
                        _this.selectedProductListCount = selectedProductList.length;
                    });
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var HomeComponent = /** @class */ (function () {
                function HomeComponent(applicationStateService) {
                ...
                HomeComponent.prototype.openSort = function () {
                ...
                HomeComponent.prototype.applyFilter = function (obj) {
                    this.filterDetail = obj;
                };
                HomeComponent.prototype.sortBy = function (sortId) {
                    this.sortId = sortId;
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ProductComponent = /** @class */ (function () {
                ...
                ProductComponent.prototype.priceAfterDiscount = function (actualPrice, discount) {
                    return actualPrice - (actualPrice * discount / 100);
                };
                ProductComponent.prototype.addToCart = function (product) {
                    var tempSelectedProduct = product;
                    tempSelectedProduct.count = 1;
                    var Selectedproduct = tempSelectedProduct;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var SortingComponent = /** @class */ (function () {
                ...
                SortingComponent.prototype.getSortId = function () {
                    return this.sortId;
                };
                SortingComponent.prototype.setSortId = function (id) {
                    this.sortId = id;
                };
                SortingComponent.prototype.submitForm = function (form) {
                ...
                SortingComponent.prototype.cancel = function () {
                    this.closePopup.emit();
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var Filter = /** @class */ (function () {
                ...
                Filter.prototype.transform = function (products, filterObj) {
                    if (!products)
                        return [];
                    if (!filterObj)
                        return products;
                    if (filterObj.type === "search") {
                        var searchText_1 = filterObj.searchText.toLowerCase();
                        return products.filter(function (product) {
                            return product.name.toLowerCase().includes(searchText_1);
                        });
                    }
                    else if (filterObj.type === "priceRange") {
                        var minPrice_1 = filterObj.priceRange[0];
                        var maxPrice_1 = filterObj.priceRange[1];
                        return products.filter(function (product) {
                            if (product.price >= minPrice_1 && product.price <= maxPrice_1) {
                                return product;
                            }
                        });
                    }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var Sort = /** @class */ (function () {
                ...
                Sort.prototype.transform = function (products, sortId) {
                    if (!products)
                        return [];
                    if (!sortId)
                        return products;
                    if (sortId === 1) {
                        return products.sort(function (a, b) {
                            var priceA = a.price - (a.price * a.discount / 100);
                            var priceB = b.price - (b.price * b.discount / 100);
                            var comparison = 0;
                            if (priceA < priceB) {
                                comparison = 1;
                            }
                        ...
                        return products.sort(function (a, b) {
                            var discountA = a.discount;
                            var discountB = b.discount;
                            var comparison = 0;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ProductService = /** @class */ (function () {
                ...
                ProductService.prototype.addSelectedProducts = function (product) {
                    var productAlreadyAdded = this.selectedProducts.find(function (addedProduct) {
                ...
                ProductService.prototype.removeSelectedProducts = function (product) {
                ...
                ProductService.prototype.updateProductCount = function (product) {
                    for (var i = 0; i < this.selectedProducts.length; i++) {
                        if (this.selectedProducts[i].id === product.id) {
                            if (product.count > 0) {
